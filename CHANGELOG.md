...
> **Releases are continuous.** Every push to `master` publishes a versioned
> release (`vYYYY.MM.DD.<build>`) whose notes are **auto-generated by CI** from
> commit messages (grouped by [Conventional Commits](https://www.conventionalcommits.org/)
> type, bilingual headings). See the full list on the
> [Releases page](https://github.com/okatu-loli/otp_migrator/releases).
>
> The entry below is the curated `1.0.0` baseline; later versions live in the
> Releases page rather than being hand-edited here.
